      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex justify-center items-center">
          <img
            ...
            className="h-96 w-96 rounded-full object-cover grayscale hover:grayscale-0 transition duration-300 ease-in-out"
            loading="lazy"
          />
        </div>
        <div className="p-4 flex flex-col justify-center items-start space-y-4">
          <p>Hello world,</p>
          <h1 className="font-bold text-black text-5xl">I'm M. H. Nahib</h1>
          ...
          <div className="flex space-x-4 mt-4 items-center text-lg font-bold">
            <p>Social </p>
            <a
